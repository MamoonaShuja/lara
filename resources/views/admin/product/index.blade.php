        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6 ">
                        <a href="{{route('admin.product.create')}}"><button class="float-right btn btn-primary"><i class="fa fa-plus"></i> Add New </button></a>
                    </div>
                </div>
            </div>
    ...
    <script>
        var table = $('#table').DataTable({
               ...
               columns: [
                    ...
                    {
                        data: 'min_whole_sale_quan', name: 'min_whole_sale_quan',
